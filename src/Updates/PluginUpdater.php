...
/**
 * Hooks into WordPress's plugin update API to provide updates from GitHub releases.
 */
class PluginUpdater extends AbstractUpdater {
    public function __construct(
        ...
        parent::__construct($packageService, $releaseService, $clientService, $repositoryService, 'plugin');
    }
}
